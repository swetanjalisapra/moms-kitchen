...
if(isset($_POST['submit']))
{
	...
	if($p==$cp){
		$result5 =  mysqli_query($conn," SELECT * FROM sysuser WHERE email='$em'") or die( mysqli_error($conn) );
			...
			{    $query = "INSERT INTO sysuser (name,email,password) 
					  VALUES('$nm','$em','$p')";
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-default mb-xl-5 mb-4">
                <div class="container-fluid">
                    ...
                    <!-- Search-from -->
                   <h2 class="main-title-w3layouts mb-2 text-center">New User</h2>
            <!--// main-heading -->
                    <!--// Search-from -->
 ...
 ?>
      ...
      <form action="user.php" method="post" enctype="multipart/form-data" >
         ...
         <div class="form-group">
		   ...
		   <label for="heading">User Email</label>
            ...
            <div class="card">
               ...
               <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                     ...
                     <tbody>
                        <?php 
                           $result1 = mysqli_query($conn," SELECT * FROM `sysuser`") or die( mysqli_error($conn) );
						...
						<td>
                           ...
                           <td>
                              <?php  echo "<a class='img11 delete' data-confirm='Are you sure to delete this item?' href=delete.php?t=6&id=".$row1['id']."> <i class='fa fa-trash' style='font-size:24px; color:red;' title='Delete'></i></a><br>";?>

                               <?php  echo "<a class='img11'  href=user-edit.php?id=".$row1['id']."> <i class='fa fa-edit' style='font-size:24px; color:green;' title='Edit'></i></a><br>";?>
                           </td>
                        </tr>
                        <?php  }
                           ?>
