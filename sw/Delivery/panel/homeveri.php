		 ...
		 <hr>
            <div class="card">
               <div class="card-header">
                  <strong class="card-title">Pending For Verification</strong>
               </div>
               <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                     <thead>
                        <tr>
						 <th>ID</th>
                           <th>Name</th>
						    <th>Chef's Name</th>
							<th>Phno </th><th>Email </th><th>Address </th><th>Description</th><th>Schedule</th><th>Verify</th>
                     ...
                     <tbody>
                        <?php 
                           $result1 = mysqli_query($conn," SELECT * FROM `home` where verify=0") or die( mysqli_error($conn) );
						...
						<td>
						   ...
						   <td>
						     ...
						     <td>
							  ...
							  ?>
							  <br>
							   <a href="schdt.php?id=<?php echo $row1['id'];?>" style="color:blue;">Re-Schedule Date</a>
							   <?php
							  }
							  else{ ?>
								  <a href="schdt.php?id=<?php echo $row1['id'];?>" style="color:blue;">Schedule Date</a>
							<?php  }?>
                          </p> </td>
						   <td>
                              <?php  echo "<a class='img11 delete' data-confirm='Are you sure to verify ?' href=verify.php?id=".$row1['id']."> <i class='fa fa-edit' style='font-size:24px; color:green;' title='Delete'></i></a><br>";?>
