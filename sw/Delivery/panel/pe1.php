...
if(isset($_POST['submit']))
{
	...
	$image= $_FILES['image']['name'];
       ...
       $target = "../../images/people".basename($image);
	...
	$query = "INSERT INTO peoplesay (name,img,say,str) 
					  VALUES('$nm','$image','$sy','$str')";
...
<form style="align-content:center;"  action="people.php" method="post" enctype="multipart/form-data" >
       ...
       <div class="form-group">
		 ...
		 <div class="form-group">
            <label for="heading">No of Star</label>
            <input type="text" class="form-control" id="heading" name="str" placeholder="Enter Name" required="">
         </div>
        <div class="form-group">
