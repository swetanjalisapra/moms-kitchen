        ...
        <div id="content">
            ...
            <nav class="navbar navbar-default mb-xl-5 mb-4">
                <div class="container-fluid">
				 ...
				 <h2 class="main-title-w3layouts mb-2 text-center">Delivery Dashboard</h2>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu drop-3">
                                <div class="profile d-flex mr-o">
									...
									<?php $username=$_SESSION['dusername'];
$result =  mysqli_query($conn," SELECT * FROM delivery WHERE email='$username'") or die( mysqli_error($conn) );

$row = mysqli_fetch_array($result);
 ?>  <div class="profile-l align-self-center">
                                        <img src="../../images/demo.jpg" class="img-fluid mb-3" alt="Responsive image">
                                    </div>
