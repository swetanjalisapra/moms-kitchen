...
if(isset($_POST['submit']))
{
   ...
   {  $target = "../../images/".basename($image);
	  ...
	  $query = "UPDATE slider set img='$image',txt='$sy' where id='$id'"; 
   }
   else{
...
?>
      ...
      <form action="slider-edit.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
        
         <br>
		  <?php   $result2 =  mysqli_query($conn," SELECT * FROM slider WHERE id='$id'") or die( mysqli_error($conn) );
...
$i=$row2['img']; ?>
		 ...
		 <div>
            ...
            <textarea type="text" rows="5" class="form-control" id="description" name="dec" placeholder="Description..."><?php echo $row2['txt'];?></textarea>
         </div>
