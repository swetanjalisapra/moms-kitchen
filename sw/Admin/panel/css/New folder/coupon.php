        ...
        <div id="content">
            ...
            <nav class="navbar navbar-default mb-xl-5 mb-4">
                <div class="container-fluid">
                    ...
                    <!-- Search-from -->
                      <h2 class="main-title-w3layouts mb-2 text-center">Coupons</h2>
                    <!--// Search-from -->
                     ...
                     <tbody>
						...
						<td>
						  ...
						  <td>
                           ...
                           <td>
                              <?php  echo "<a class='img11 delete' data-confirm='Are you sure to delete this item?' href=delete.php?t=10&id=".$row2['id']."> <i class='fa fa-trash' style='font-size:24px; color:red;' title='Delete'></i></a><br>";?>
