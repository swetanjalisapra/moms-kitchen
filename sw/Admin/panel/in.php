...
if(isset($_POST['submit']))
{
	...
	$query = "INSERT INTO incat (nm,descrip) 
					  VALUES('$nm','$des')";
					 // echo $query;
            ...
            <div class="card">
               ...
               <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                     ...
                     <tbody>
                        <?php 
                           $result1 = mysqli_query($conn," SELECT * FROM `incat`") or die( mysqli_error($conn) );
						...
						<td>
                           ...
                           <td>
                              <?php  echo "<a class='img11 delete' data-confirm='Are you sure to delete this item?' href=delete.php?t=2&id=".$row1['id']."> <i class='fa fa-trash' style='font-size:24px; color:red;' title='Delete'></i></a><br>";?>
                               ...
                               <?php  echo "<a class='img11'  href=in-edit.php?id=".$row1['id']."> <i class='fa fa-edit' style='font-size:24px; color:green;' title='Edit'></i></a><br>";?>
                           </td>
                        </tr>
                        <?php  }
                           ?>
