        ...
        <nav id="sidebar">
		  ...
		  <li>
            ...
            <div class="collapse" id="ui-basic1">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="homes.php"> All Kitchens</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="homeveri.php">Pending for verification</a>
                </li>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-default mb-xl-5 mb-4">
                <div class="container-fluid">
				 ...
				 <h2 class="main-title-w3layouts mb-2 text-center">Admin Dashboard</h2>
