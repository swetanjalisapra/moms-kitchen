...
if(isset($_POST['submit']))
{
	...
	$query = "UPDATE peoplesay set name='$nm',img='$image',say='$sy' where id='$id'";
	
	}
	else{
		$query = "UPDATE peoplesay set name='$nm',say='$sy' where id='$id'";
	}
...
<form style="align-content:center;"  action="menu-edit.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" >
       
         <br>
        <?php   $result2 =  mysqli_query($conn," SELECT * FROM menu WHERE id='$id'") or die( mysqli_error($conn) );
