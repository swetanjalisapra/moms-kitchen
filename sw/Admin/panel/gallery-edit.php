...
if(isset($_POST['submit']))
{
   ...
   {  $target = "../../images/".basename($image);
	  ...
	  $query = "UPDATE gallery set img='$image' where id='$id'"; 
   }
...
?>
      ...
      <form action="gallery-edit.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
        
         <br>
		  <?php   $result2 =  mysqli_query($conn," SELECT * FROM gallery WHERE id='$id'") or die( mysqli_error($conn) );
