            ...
            <div class="card">
               ...
               <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                     <thead>
                        <tr>
	                     ...
	                     <th>Name</th>
							...
							<th>Address</th>
							<th>Total Amount</th>  
							<th>Coupon</th><th>Txn ID</th><th>Delivery ID</th>
							<th>Status</th>
                     ...
                     <tbody>
                        <?php 
                           $result1 = mysqli_query($conn," SELECT * FROM `orders` WHERE date='$dt' ORDER BY ID DESC") or die( mysqli_error($conn) );
						...
						<td>
						   ...
						   <td>
						     ...
						     <td>
                              ...
                              <?php echo "<p>".$row1['total']."</p>"; ?>
                           </td> <td>
                              <?php echo "<p>".$row1['coupon']."</p>"; ?>
                           </td>  <td>
                              <?php echo "<p>".$row1['txnid']."</p>"; ?>
                           </td>
						   <td>
                              <?php echo "<p>".$row3['did']."</p>"; ?>
                           </td>
						     <td>  
						   <p><?php if($row1['stts']==1){ ?>
							  ...
							  <?php }
							  elseif($row1['stts']==2){ ?>
							<div id="element" onclick="abc(<?php echo $row1['id'];?>)"class="btn btn-default">Approved</div>
							  <?php }
							  else if($row1['stts']==3){ ?>
Delivered
							  <?php }
