...
<div class="blog">
	<div class="container">
	  ...
	  <br>
  <form action="paytm/pgRedirect.php" method="POST" style="
    margin-left: 40%;">
  <input name="orderid" value="<?php echo $id;  ?>" hidden>
   <br> <br>
   <input name="uid" value="UID<?php echo $row4['uid']; ?>" hidden> <input name="amt" value="<?php echo $row4['total']; ?>" hidden> <input type="submit" name="submit" value="Continue To Pay">
  </form>
			</div>
