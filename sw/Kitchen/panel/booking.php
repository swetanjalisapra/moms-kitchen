            ...
            <div class="card">
               ...
               <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                        ...
                        <tr>
						 <th>Booking ID</th>
                           <th>Order ID</th>
						    ...
						    <th>User Name</th>
							<th>User Phno</th>
							<th>Tour Name</th><th>No. of guest</th><th>Amount</th><th>Coupon</th><th>Payment</th><th>Status</th><th>Traveller Details</th>
                     ...
                     <tbody>
                        <?php 
                           $result1 = mysqli_query($conn," SELECT * FROM `booking` where sts!=2") or die( mysqli_error($conn) );
						...
						<td>
						    ...
						    <td>
                              <?php echo "<p><a href='userdet.php?id=".$row2['id']."' style='color:blue;'>".$row2['name']."</a></p>"; ?>
                           </td>
						   <td>
