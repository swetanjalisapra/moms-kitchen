...
if(isset($_POST['submit']))
{
	...
	$query = "INSERT INTO promo (name,vlink,clink) 
					  VALUES('$nm','$vl','$cl')";
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-default mb-xl-5 mb-4">
                <div class="container-fluid">
                    ...
                    <!-- Search-from -->
                   <h2 class="main-title-w3layouts mb-2 text-center">Promotions</h2>
                    <!--// Search-from -->
...
<form style="align-content:center;"  action="promo.php" method="post" enctype="multipart/form-data" >
       
         <br>
       
         <div class="form-group">
            <label for="heading">Promotion Name</label>
            <input type="text" class="form-control" id="heading" name="name" placeholder="Name..." required="">
         </div>
         <div class="form-group">
            <label for="price">Video Link</label>
            <input type="text" class="form-control" id="price" name="vlink" placeholder="Video link(Only the last clause After http://youtube.com/)" required="">
         </div>
         <div class="form-group">
            <label for="cut price">Channel Link</label>
            <input type="text" class="form-control" id="cutprice" name="clink" placeholder="Paste here Channel Link">
	   ...
	   <br> &nbsp;&nbsp;&nbsp;&nbsp;<a href="music.php"><button class="btn btn-primary btn-sm"><i class="fa fa-dot-circle-o"></i>Update Site Music </button></a>
	  </div>
            ...
            <div class="card">
               ...
               <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                     ...
                     <tbody>
                        <?php 
                           $result1 = mysqli_query($conn," SELECT * FROM `promo`") or die( mysqli_error($conn) );
						...
						<td>
						   ...
						   <td>
                              ...
                              <?php echo "<p>".$row1['vlink']."</p>"; ?>
                           </td><td>
                              <?php echo "<p>".$row1['clink']."</p>"; ?>
                           </td>
                        	
                           
                          
                           <td>
                              <?php  echo "<a class='img11 delete' data-confirm='Are you sure to delete this item?' href=delete.php?t=4&id=".$row1['id']."> <i class='fa fa-trash' style='font-size:24px; color:red;' title='Delete'></i></a><br>";?>

                               <?php  echo "<a class='img11'  href=promo-edit.php?id=".$row1['id']."> <i class='fa fa-edit' style='font-size:24px; color:green;' title='Edit'></i></a><br>";?>
                           </td>
                        </tr>
                        <?php  }
                           ?>
