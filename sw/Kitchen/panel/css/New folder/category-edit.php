...
if(isset($_POST['submit']))
{
	...
	$query = "UPDATE category SET name='$nm' where id ='$id'";
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-default mb-xl-5 mb-4">
                <div class="container-fluid">
                    ...
                    <!-- Search-from -->
                    <h2 class="main-title-w3layouts mb-2 text-center">Edit Category</h2>
                    <!--// Search-from -->
...
$row = mysqli_fetch_array($result);
 ?>
      ...
      <form action="category-edit.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" >
