        ...
        <div id="content">
            ...
            <nav class="navbar navbar-default mb-xl-5 mb-4">
                <div class="container-fluid">
                    ...
                    <!-- Search-from -->
                   <h2 class="main-title-w3layouts mb-2 text-center">Customer's List</h2>
            <!--// main-heading -->
                    <!--// Search-from -->
...
$row = mysqli_fetch_array($result);
 ?>
    ...
    <div class="card-footer">
           <a href="expo.php"> <button type="submit" name="submit" class="btn btn-primary btn-sm">
            <i class="fa fa-dot-circle-o"></i> Export to Excel</a>
                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                     <thead>
                        <tr>
						 <th>User ID</th>
                           <th>Name</th>
						    <th>Email</th> <th>Phno</th> <th>Password</th> 
                           
                        </tr>
                     </thead>
                     <tbody>
                        <?php 
                           $result1 = mysqli_query($conn," SELECT * FROM `user`") or die( mysqli_error($conn) );
