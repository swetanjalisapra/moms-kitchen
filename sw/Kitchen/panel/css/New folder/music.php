        ...
        <div id="content">
            ...
            <nav class="navbar navbar-default mb-xl-5 mb-4">
                <div class="container-fluid">
                    ...
                    <!-- Search-from -->
                     <h2 class="main-title-w3layouts mb-2 text-center">Add Music</h2>
            <!--// main-heading -->
                    <!--// Search-from -->
...
$row = mysqli_fetch_array($result);
 ?>
      ...
      <form action="music.php" method="post" enctype="multipart/form-data">
	   ...
	   <br> &nbsp;&nbsp;&nbsp;&nbsp;<a href="promo.php"><button class="btn btn-primary btn-sm"><i class="fa fa-dot-circle-o"></i>Back To Promotions </button></a>
	  </div>
            ...
            <div class="card">
               ...
               <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                     ...
                     <tbody>
                        <?php 
                           $result1 = mysqli_query($conn," SELECT * FROM `music` ORDER BY id DESC limit 1") or die( mysqli_error($conn) );
                           while ($row1 = mysqli_fetch_array($result1)) {
                           ?>
                        <tr>
						
                        	<td>
                        		<iframe width="250" height="200" src="https://www.youtube.com/embed/<?php echo $row1['nm']; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        	</td>
                           
                          
                           <td>
                              <?php  echo "<a class='img11 delete' data-confirm='Are you sure to delete this item?' href=delete.php?t=9&id=".$row1['id']."> <i class='fa fa-trash' style='font-size:24px; color:red;' title='Delete'></i></a><br>";?>
