...
if(isset($_POST['submit']))
{
	...
	$query = "INSERT INTO people (name,img,say) 
					  VALUES('$nm','$image','$sy')";
...
<form style="align-content:center;"  action="people.php" method="post" enctype="multipart/form-data" >
            ...
            <div class="card">
               ...
               <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                     ...
                     <tbody>
                        <?php 
                           $result1 = mysqli_query($conn," SELECT * FROM `people`") or die( mysqli_error($conn) );
						...
						<td>
                           ...
                           <td>
                              <?php  echo "<a class='img11 delete' data-confirm='Are you sure to delete this item?' href=delete.php?t=6&id=".$row1['id']."> <i class='fa fa-trash' style='font-size:24px; color:red;' title='Delete'></i></a><br>";?>
                               ...
                               <?php  echo "<a class='img11'  href=people-edit.php?id=".$row1['id']."> <i class='fa fa-edit' style='font-size:24px; color:green;' title='Edit'></i></a><br>";?>
                           </td>
                        </tr>
                        <?php  }
                           ?>
