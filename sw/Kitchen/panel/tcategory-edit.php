...
$target = "../../images/tcat/".basename($image);
	...
	$query = "UPDATE tcategory set name='$nm',img='$image',descrip='$des' where id='$id'";
	
	}
	else{
		$query = "UPDATE tcategory set name='$nm',descrip='$des' where id='$id'";
	}
...
<body>
    <div class="wrapper">
      ...
      <form action="tcategory-edit.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" >
       <?php 
                           $result1 = mysqli_query($conn," SELECT * FROM `tcategory` where id='$id'") or die( mysqli_error($conn) );
		 ...
		 <div>
			<img src="../../images/tcat/<?php echo $i; ?>" height="100px" width="100px">
			</div>
